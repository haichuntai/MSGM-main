...
data_root = '/data/thc/data/cuhk_sysu/' #'/home/ms/wjb/code/CGPS/data/cuhk/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotation/train_unsupervised_pid.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotation/test_pid.json',
        img_prefix=data_root + 'Image/SSM/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
